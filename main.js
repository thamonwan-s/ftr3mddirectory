        ...
        return `
          <div class="bg-white p-2 rounded-xl shadow-sm border border-gray-100 w-full max-w-sm mx-auto my-2"> 
            ...
            <div class="grid grid-cols-[1fr,auto,1fr] items-center text-lg font-black text-[#333333] my-1 gap-2">
              <div class="flex flex-col items-center justify-start gap-1 overflow-hidden">
              ...
              <div class="grid grid-cols-[1fr,auto,1fr] items-center gap-1 px-2">
                    <div class="flex text-xs font-bold text-gray-800 items-center text-center justify-center">${formatTime(data[rowIdx+1][setIdx+3])}</div>
                    <div class="text-gray-300 text-sm justify-center mx-2">→</div>
                    <div class="flex text-xs font-bold text-gray-800 items-center text-center justify-center">${formatTime(data[rowIdx+1][setIdx+4])}</div>
                </div>
              
              <div class="flex flex-col items-center justify-end text-right gap-1 overflow-hidden">
