...
const headerHTML = `
  <div id="main-header-wrapper">
    <div class="w-full bg-[#333333] flex items-center justify-between px-4 gap-x-8" style="height: 26px;">
      ...
      <nav class="flex items-center space-x-3">
        ...
        <a href="flights.html" class="text-white hover:text-gray-300" style="font-size: 8pt;">Flights</a>
        <a href="#" class="text-white hover:text-gray-300" style="font-size: 8pt;">Schedule</a>
      </nav>
    </div>
